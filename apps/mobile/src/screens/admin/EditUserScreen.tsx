...
const styles = StyleSheet.create({
  ...
  roleRow: { flexDirection: 'row', padding: 4, borderRadius: 12, gap: 4 },
  ...
  disabledBanner: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 16, paddingVertical: 12, borderRadius: 14 },
