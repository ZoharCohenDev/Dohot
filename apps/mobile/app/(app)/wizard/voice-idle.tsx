...
const styles = StyleSheet.create({
  ...
  aiLabel: { flexDirection: 'row-reverse', alignItems: 'center', gap: 8, marginBottom: 12 },
  aiLabelText: { color: voiceColors.sageLight, fontSize: 12, fontWeight: '700', letterSpacing: 1, textAlign: 'right' },
  title: { fontSize: 30, fontWeight: '500', color: voiceColors.textPrimary, letterSpacing: -0.6, lineHeight: 34, textAlign: 'right' },
  body2: { fontSize: 15, color: voiceColors.textSecondary, lineHeight: 23, marginTop: 12, textAlign: 'right' },
  promptsLabel: { marginTop: 22, marginBottom: 8 },
  promptsLabelText: { fontSize: 11, fontWeight: '700', color: voiceColors.textMuted, letterSpacing: 1, textTransform: 'uppercase', textAlign: 'right' },
  promptRow: {
  ...
  promptText: { fontSize: 14, color: voiceColors.textSecondary, flex: 1, textAlign: 'right' },
  micSection: {
    alignItems: 'center',
    gap: 14,
    paddingTop: 24,
